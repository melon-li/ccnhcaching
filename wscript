...
def build(bld):
    module = bld.create_ns3_module('ccnhcaching', ['core'])
    module.source = [
        'model/ccnhcaching.cc',
		'model/ccnhcaching.cc',
		'model/CcnModule.cc',
		'model/CCN_Name.cc',
    ...
    module_test = bld.create_ns3_module_test_library('ccnhcaching')
    module_test.source = [
        'test/ccnhcaching-test-suite.cc',
        ]

    headers = bld(features='ns3header')
    headers.module = 'ccnhcaching'
    headers.source = [
        'model/ccnhcaching.h',
       	'model/ccnhcaching.h',
		'model/CcnModule.h',
